...
export default function HouseholdsError({ reset }: { reset: () => void }) {
  return (
        ...
        <div className="mx-auto max-w-7xl">
          <section className="rounded-lg border border-rose-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 max-w-2xl text-sm text-slate-600">
              Start the FastAPI backend and try again. The household list reads
              from the operational database through the backend API.
            </p>
            <button
              type="button"
              onClick={() => reset()}
